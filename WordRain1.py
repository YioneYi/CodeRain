...
#定义一些窗体参数及加载字体文件
SCREEN_WIDTH  = 1080        # 窗体宽度
SCREEN_HEIGHT = 720         # 窗体宽度
LOW_SPEED  = 1              # 字体移动最低速度
HIGH_SPEED = 10             # 字体移动最快速度
FONT_COLOR = (64,224,208)    # 字体颜色
FONT_SIZE = 20              # 字体尺寸
FONT_NOM  = 20              # 显示字体数量，从0开始
FONT_NAME = "C:/Windows/Fonts/times.ttf"  # 注意字体的文件名必须与真实文件完全相同（注意ttf的大小写），且文件名不能是中文
FREQUENCE = 10              # 时间频度
times = 0                   # 初始化时间
